...
const About = () => {
  return (
    ...
    <div className='flex justify-center items-center md:justify-end p-3 md:p-4 md:mr-32 mt-8 md:mt-16'>
        ...
        <h1 className='text-[28px]  md:text-[44px] md:w-[320px] font-bold pr-8 md:pr-0'>Empowering Individuals & Businesses with Expert Tax Solutions</h1>
        <p className='text-[16px] md:w-[360px] mt-4 pr-8 md:pr-0 '>Our registered tax practitioners carefully review your submission for accuracy, compliance, and potential tax savings. Once verified, we lodge your tax return with the Australian Taxation Office (ATO) on your behalf.</p>
      
        <div className='bg-[#EDF5FF] md:bg-[#FFAB914D] w-[340px] md:w-[376px] h-[220px]  flex mt-4 rounded-[10px] '>
           ...
           <Image src="/pie-chart1.png" alt="rectangle" width={32} height={32} className='absolute top-3 left-3'/>
            ...
            <div className='flex flex-col  ml-4 mt-5 mb-5 '>
