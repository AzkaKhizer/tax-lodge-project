...
const About = () => {
  return (
    ...
    <div className='flex justify-center items-center md:justify-end p-4 md:mr-32 mt-8 md:mt-16'>
        ...
        <div className='bg-[#EDF5FF] md:bg-[#FFAB914D] w-[376px] h-[220px] flex mt-4 rounded-[10px] '>
